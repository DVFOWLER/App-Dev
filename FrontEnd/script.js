...
// 2. Update showGreeting() to handle the Seller display
// Find the existing showGreeting() and ensure it sets the name correctly
if($('#username-display')) {
...
// 4. Update the DOMContentLoaded boot logic at the bottom
document.addEventListener('DOMContentLoaded', ()=>{
  // ... existing logic ...

  // Add this block for the Seller Dashboard
  if(location.pathname.endsWith('seller-dashboard.html')){
    ...
    renderAdminProducts(); // We reuse your product manager!
    
    // Update seller-specific stats
...
const defaultProducts = [
  {id:'carbonx-spinning-rod-6-6', name:'CarbonX Spinning Rod 6\'6"', price:1490, stock:25, category:'rods', image_url:'https://m.media-amazon.com/images/I/61RK9bbUpeL._AC_SY300_SX300_QL70_ML2_.jpg'},
